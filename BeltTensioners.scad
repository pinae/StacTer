...
module Z_belt_tensioner_base() {
    difference() {
        union() {
            ...
            translate([5, 25, -15.2]) cylinder(d=7.6, h=10, $fn=res);
            translate([5, -25, -15.2]) cylinder(d=7.6, h=10, $fn=res);
            translate([-7, 2, -15.2]) cylinder(d=7.6, h=10, $fn=res);
        }
        translate([5, 25, -16]) cylinder(d=4.3, h=18, $fn=res);
        translate([5, -25, -16]) cylinder(d=4.3, h=18, $fn=res);
        translate([-7, 2, -16]) cylinder(d=4.3, h=18, $fn=res);
        translate([5, 25, -3.5]) cylinder(d=8.8+0.5, h=18, $fn=6);
        translate([5, -25, -3.5]) cylinder(d=8.8+0.5, h=18, $fn=6);
        translate([-7, 2, -3.5]) cylinder(d=8.8+0.5, h=18, $fn=6);
        translate([0, 13, -9]) {
            cylinder(d=5.5, h=10, $fn=res);
            cylinder(d=8, h=7, $fn=res);
        }
        translate([0, -11, -9]) {
            cylinder(d=5.5, h=10, $fn=res);
            cylinder(d=8, h=7, $fn=res);
