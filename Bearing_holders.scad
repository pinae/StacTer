...
module Z_bearing_spacer() {
    union () {
        cylinder(d=15, h=6, $fn=res);
        translate([0, 0, -1.3]) cylinder(d=7.8, h=6, $fn=res);
    }
}

XY_bearing_holder();
//translate([13, 14, -18]) axialBallbearing();
//translate([13, 14, -13]) Z_bearing_spacer();
